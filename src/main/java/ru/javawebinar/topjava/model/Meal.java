...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.TIME_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String TIME_BETWEEN = "Meal.getBetweenHalfOpen";
